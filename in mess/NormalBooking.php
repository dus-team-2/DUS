...
<body>
<div>
    <p><h1>booking</h1><h2>User:<?php  session_start();echo  $_SESSION['name'];?></h2></p>
    ...
    <form style=" margin-left:400px; margin-top:200px;" action="insert.php" method="post">
        ...
        <br />
        <dd style="margin-top:20px;">Date:<input type="date" name="date"  min="2019-05-01" max="2030-01-01" />
